...
my_PDS = 'scaleout_samurdhi'#'unif_poor'#'scaleout_samurdhi_universal'#'samurdhi_scaleup'#'samurdhi_scaleup00'#
base_str = 'no'
...
iah['c_pre_reco']   = iah.eval('c_initial+@drm_pov_sign*dc_pre_reco')
...
#
iah_ntl['c_pov_pc_f'] = myiah.loc[myiah.eval('c_initial-dc_pre_reco<=pov_line'),'pcwgt_no'].sum(level=['hazard','rp'])
iah_ntl['i_pov_pc_f'] = myiah.loc[myiah.eval('c_initial-di_pre_reco<=pov_line'),'pcwgt_no'].sum(level=['hazard','rp'])
#
iah_ntl['c_sub_pc_f'] = myiah.loc[myiah.eval('c_initial-dc_pre_reco<=sub_line'),'pcwgt_no'].sum(level=['hazard','rp'])
iah_ntl['i_sub_pc_f'] = myiah.loc[myiah.eval('c_initial-di_pre_reco<=sub_line'),'pcwgt_no'].sum(level=['hazard','rp'])
#
