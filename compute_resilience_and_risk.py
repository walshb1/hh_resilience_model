...
macro_event, cats_event_ia = compute_dK(macro_event, cats_event,event_level,affected_cats,pol_str) #calculate the actual vulnerability, the potential damange to capital, and consumption
print('B\n\n')
...
out = compute_dW(myCountry,macro_event,cats_event_iah,event_level,option_CB,return_stats=True,return_iah=True)
print('F')
